...
public class SolutionController {
  ...
  public ResponseEntity<?> createGeneratedSolutions(@RequestBody List<Solution> solutions) {
    boolean valid = solutions.stream().allMatch(s -> !s.isUserSolution() && s.isCorrect());
    if (!valid)
      return ResponseEntity.badRequest().body("Each generated solution must be correct and not user-generated.");
